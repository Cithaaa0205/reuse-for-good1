        ...
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div class="flex-1 text-center sm:text-left">
                <div class="flex flex-col sm:flex-row justify-between items-center mb-2">
                    ...
                    @if(Auth::check() && Auth::id() == $user->id)
                        <a href="{{ route('profile.edit') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 mt-3 sm:mt-0">
    ...
    <div class="mb-6">
        <div class="border-b border-gray-300">
            <nav class="flex -mb-px space-x-6" x-data="{ activeTab: 'donasi' }" x-cloak>
                ...
                @if(Auth::check() && Auth::id() == $user->id)
                    <a href="#diterima" @click.prevent="activeTab = 'diterima'"
                       :class="{ 'border-blue-600 text-blue-600': activeTab === 'diterima', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-400': activeTab !== 'diterima' }"
                       class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200">
                        Barang Diterima
                    </a>
                    <a href="#favorit" @click.prevent="activeTab = 'favorit'"
                       :class="{ 'border-blue-600 text-blue-600': activeTab === 'favorit', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-400': activeTab !== 'favorit' }"
                       class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200">
                        Favorit
                    </a>
                @endif
